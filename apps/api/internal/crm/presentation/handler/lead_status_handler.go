...
// LeadStatusHandler handles HTTP requests for lead statuses
type LeadStatusHandler struct {
	uc usecase.LeadStatusUsecase
}

// NewLeadStatusHandler creates a new lead status handler
func NewLeadStatusHandler(uc usecase.LeadStatusUsecase) *LeadStatusHandler {
	return &LeadStatusHandler{uc: uc}
}

// Create handles POST request to create a lead status
func (h *LeadStatusHandler) Create(c *gin.Context) {
	var req dto.CreateLeadStatusRequest
...
// GetByID handles GET request to get a lead status by ID
...
// List handles GET request to list lead statuses
...
// Update handles PUT request to update a lead status
...
// Delete handles DELETE request to delete a lead status
func (h *LeadStatusHandler) Delete(c *gin.Context) {
	...
	response.SuccessResponseDeleted(c, "crm_lead_status", id, meta)
}

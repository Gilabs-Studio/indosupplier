...
const FinanceBankAccountsContainer = dynamic(
  () =>
    import("@/features/finance/bank-accounts/components").then((mod) => ({
      default: mod.FinanceBankAccountsContainer,
    })),
  { loading: () => null },
);
